...
const uri_request_parser_1 = require("../src/mapper/uri-request-parser");
const context_mapper_1 = require("../src/mapper/context-mapper");
...
class TestSetup {
    ...
    startTest() {
        ...
        this.requestListeners.push(new context_mapper_1.ContextMapperProxyRequestListener(new uri_request_parser_1.UriRequestParser(this.log), this.log));
